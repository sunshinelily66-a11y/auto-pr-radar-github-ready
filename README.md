...
本次针对第一次真实运行暴露出的两个问题调整：

1. `竞品动作` 增加国内竞品覆盖，并在栏目选取时保证国内信息优先。
2. `市场` 拆出独立 `竞品销量`，把理想、小鹏、比亚迪、吉利/极氪、赛力斯/问界、零跑等月度交付与产销变化纳入日报。

新增或强化官方源：

- 理想 IR 月度 Delivery Update
- 小鹏 IR Vehicle Delivery Results
- BYD 投资者关系月度产销公告
- 吉利汽车官方 Press Release 月度销量
- 赛力斯官方产销快报
- 阿维塔官方新闻中心
- ZEEKR Group 官方新闻
- 鸿蒙智行 HIMA 官方站
...
同时修改筛选逻辑：国内行业媒体只要明确提到重点竞品，并且标题出现上市、价格、技术、战略、合作等动作信号，也可以进入 `竞品动作`，不再要求来源本身必须标记为 `competitor`。
